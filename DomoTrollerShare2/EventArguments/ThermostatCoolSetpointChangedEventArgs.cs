...
{
    public class ThermostatCoolSetpointChangedEventArgs : EventArgs
    {
        public ThermostatCoolSetpointChangedEventArgs(Guid tenantId, string thermostatId, Guid thermostatGuid,  double? newCoolSetpoint)
        {
            TenantId = tenantId;
